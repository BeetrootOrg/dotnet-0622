...
internal class Convention
{
    ...
    public Convention(int publicProperty, int privateProperty, int internalProperty, int protectedProperty, int publicField, int privateField, int internalField, int protectedField)
    {
